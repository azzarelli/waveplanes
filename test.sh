...
# EXPNAME='standup_lr_w3_60k_singlefeatplane_psn'
# PYTHONPATH='.' python plenoxels/main.py --config-path $CONFIG  expname=$EXPNAME

# CONFIG=plenoxels/configs/final/D-NeRF/lego.py
...
# CONFIG=plenoxels/configs/final/DyNeRF/cut_beef.py
# EXPNAME='cutbeef'
# PYTHONPATH='.' python plenoxels/main.py --config-path $CONFIG  expname=$EXPNAME


# CONFIG=plenoxels/configs/final/DyNeRF/spinach.py
# EXPNAME='spinach_8x'
# PYTHONPATH='.' python plenoxels/main.py --config-path $CONFIG  expname=$EXPNAME

# # CONFIG=plenoxels/configs/final/DyNeRF/spinach_w3.py
# EXPNAME='spinach_w3'
# PYTHONPATH='.' python plenoxels/main.py --config-path $CONFIG  expname=$EXPNAME
